...
# Avatar / Presenter Modes (Fase V14-C)
AVATAR_MODE_NONE = "none"
AVATAR_MODE_CORNER = "corner"
AVATAR_MODE_HYBRID = "hybrid"
AVATAR_MODE_FULL = "full"
DEFAULT_AVATAR_MODE = AVATAR_MODE_NONE
...
AVATAR_POSITION_BOTTOM_RIGHT = "bottom_right"
AVATAR_POSITION_BOTTOM_LEFT = "bottom_left"
AVATAR_POSITION_BOTTOM_CENTER = "bottom_center"
DEFAULT_AVATAR_POSITION = AVATAR_POSITION_BOTTOM_RIGHT

AVATAR_POSITIONS = [
    AVATAR_POSITION_BOTTOM_RIGHT,
    AVATAR_POSITION_BOTTOM_LEFT,
    AVATAR_POSITION_BOTTOM_CENTER,
]
